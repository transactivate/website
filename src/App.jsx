...
const MethodologyKey = () => (
  <section id="solution" className="scroll-mt-20 pt-8 md:pt-10 pb-32 relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
...
const FaqKey = () => (
  <motion.div 
    ...
    className="w-full xl:container mx-auto px-6 md:px-8 pt-8 md:pt-10 pb-16 md:pb-32 border-t border-brand-steel/10 relative"
  >
...
const WhitepapersKey = () => (
  <motion.div 
    ...
    viewport={{ once: true, margin: "-100px" }}
    transition={{ duration: 0.8 }}
    className="w-full xl:container mx-auto px-6 md:px-8 pt-8 md:pt-10 pb-16 md:pb-32 border-t border-brand-steel/10 relative print:hidden"
  >
...
const ContactKey = () => (
   <motion.div 
    ...
    viewport={{ once: true, margin: "-100px" }}
    transition={{ duration: 0.8 }}
    className="w-full container mx-auto px-6 md:px-8 pt-8 md:pt-10 pb-16 md:pb-32 border-t border-brand-steel/10 text-center"
  >
